...
import com.example.pawmatch.component.DogInfoCard
import com.example.pawmatch.component.InfoCard
import com.example.pawmatch.component.OwnerCard
import com.example.pawmatch.data.DemoDatabase
...
fun DetailsView(id: Int) {
    LazyColumn(
        ...
        val dog = DemoDatabase.dogList[id]
